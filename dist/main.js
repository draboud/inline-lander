(() => {
  ...
  var ActivateSectionBtns = function() {
  ...
  var ActivateAllCtrlBtns = function() {
    ctrlBtnWrapper.querySelectorAll(".ctrl-btn.instructions").forEach(function(el) {
  ...
  var HideInstructionCtrlBtns = function() {
    {
      ...
      if (vidsToHideCounter !== 0) {
        for (let i = 0; i < vidsToHideCounter; i++) {
          [...ctrlBtnWrapper.querySelectorAll(".ctrl-btn.instructions")][LONGEST_INST_VIDS_COUNT - 1 - i].style.display = "none";
        }
      }
    }
  };
